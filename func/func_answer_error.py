...
def answer_error() -> str:
    answer_error_list = [
        ...
        'Надеемся сегодня не понедельник, а то будет в двойне обидно.',
        (
            'Возможно, Вы что-то сделали не так, возможно, мы. В прочем какая' +
        ...
        'Хм, нужно подумать...',
        'Подравляем, Вы нашли место, которое не работает. Сообщите Нам!',
        (
